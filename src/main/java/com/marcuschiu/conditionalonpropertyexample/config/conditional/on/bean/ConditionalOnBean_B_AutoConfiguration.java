...
@Configuration
public class ConditionalOnBean_B_AutoConfiguration {
    ...
    @Bean
    @ConditionalOnBean
    public String methodConditionalOnBeanConfig1b() {
     ...
     */
    @Bean
    @ConditionalOnBean(name = "methodConditionalOnBeanConfig1b")
    public String methodConditionalOnBeanConfig2b() {
        System.out.println("inside - @ConditionalOnBean - ConditionalOnBeanConfigB.methodConditionalOnBeanConfig2()");
        return "ConditionalOnBeanConfigB.methodConditionalOnBeanConfig2";
    }
